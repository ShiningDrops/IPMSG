package com.ape.ipmsg.net;

import android.os.Message;
import android.util.Log;

import com.ape.ipmsg.activity.MyFeiGeActivity;
import com.ape.ipmsg.activity.MyFeiGeBaseActivity;
import com.ape.ipmsg.data.ChatMessage;
import com.ape.ipmsg.data.User;
import com.ape.ipmsg.interfaces.ReceiveMsgListener;
import com.ape.ipmsg.utils.IpMessageConst;
import com.ape.ipmsg.utils.IpMessageProtocol;
...
public class NetThreadHelper implements Runnable {
    ...
    public synchronized void sendUdpData(final String sendStr, final InetAddress sendto, int sendPort) {    //发送UDP数据包的方法
        try {
